...
var autoAdvance = setInterval(rightAdvance,15000);
var figureCount = 3;
...
//   articleEl.appendChild(lastFigure);
   ...
   numberButton.innerHTML = "Less menu items";
...
function previewThree() {
   ...
   numberButton.innerHTML = "More menu items";
   if (numberButton.addEventListener) {
...
function zoomFig() {
   var propertyWidth = 800;
   var propertyHeight  = 500;
   var winLeft = ((screen.width - propertyWidth) / 2);
   var winTop = ((screen.height - propertyHeight) / 2);
   var winOptions = "width=800,height=500";
